...
import { createHeroesEmbed, createItemsEmbed, createPowersEmbed } from "./embedCreators";
...
export async function sendPowersEmbed(
    ...
    const pageCreator = (page: number, totalPages: number): PageData => {
        return createPowersEmbed(powers, page, totalPages, powersPerPage, embedColor);
    }
