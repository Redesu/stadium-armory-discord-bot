...
import { sendPowersEmbed, sendItemsEmbed, sendHeroesEmbed } from "../embeds/embedHandlers";
...
export async function handlePowersResponse(interaction: ChatInputCommandInteraction, powers: any[]): Promise<void> {
...
export async function handleItemsResponse(interaction: ChatInputCommandInteraction, items: any[]): Promise<void> {
